...
namespace UbStudyHelp.Controls
{
    ...
    public partial class SearchDataEntry : UserControl
    {
        ...
        public void Initialize()
        {
            SetAppearence();
            SetFontSize();
            luceneLeft = new LuceneBookSearch(StaticObjects.Parameters.UbStudyHelpTubFilesSourcePath, StaticObjects.Book.LeftTranslation);
            luceneRight = new LuceneBookSearch(StaticObjects.Parameters.UbStudyHelpTubFilesSourcePath, StaticObjects.Book.RightTranslation);
